...
// Runs via `tsx scripts/fetch-charts.ts` in GitHub Actions (weekly, Tuesdays 06:00 UTC).
//
...
const COUNTRY_CONFIGS: ChartConfig[] = [
  {
    ...
    name: 'Germany Top 50',
    type: 'country',
    description: 'Top 50 most listened tracks in Germany, updated weekly.',
    method: 'country',
    param: 'germany',
    country: 'de',
    countryName: 'Germany',
  ...
  },
  {
    ...
    name: 'Austria Top 50',
    type: 'country',
    description: 'Top 50 most listened tracks in Austria, updated weekly.',
    method: 'country',
    param: 'austria',
    country: 'at',
    countryName: 'Austria',
  ...
  },
  {
    ...
    type: 'country',
    description: 'Top 50 most listened tracks in Switzerland, updated weekly.',
    method: 'country',
    param: 'switzerland',
    country: 'ch',
  ...
  },
  {
    ...
    type: 'country',
    description: 'Top 50 most listened tracks in the United States, updated weekly.',
    method: 'country',
    param: 'united states',
    country: 'us',
  ...
  },
  {
    ...
    type: 'country',
    description: 'Top 50 most listened tracks in the United Kingdom, updated weekly.',
    method: 'country',
  ...
  },
  {
    ...
    name: 'France Top 50',
    type: 'country',
    description: 'Top 50 most listened tracks in France, updated weekly.',
    method: 'country',
    param: 'france',
    country: 'fr',
    countryName: 'France',
  ...
  },
  {
    ...
    name: 'Japan Top 50',
    type: 'country',
    description: 'Top 50 most listened tracks in Japan, updated weekly.',
    method: 'country',
    param: 'japan',
    country: 'jp',
    countryName: 'Japan',
  ...
  },
  {
    ...
    type: 'country',
    description: 'Top 50 most listened tracks in South Korea, updated weekly.',
    method: 'country',
  ...
  },
  {
    ...
    name: 'Brazil Top 50',
    type: 'country',
    description: 'Top 50 most listened tracks in Brazil, updated weekly.',
    method: 'country',
    param: 'brazil',
    country: 'br',
    countryName: 'Brazil',
  ...
  },
  {
    ...
    type: 'country',
    description: 'Top 50 most listened tracks in Australia, updated weekly.',
    method: 'country',
    param: 'australia',
    country: 'au',
...
const GENRE_CONFIGS: ChartConfig[] = [
  ...
  description: `Top ${GENRE_DISPLAY_NAMES[genre] ?? genre} tracks worldwide, updated weekly from Last.fm.`,
  method: 'tag' as const,
  param: genre,
  genre,
...
const GLOBAL_CONFIG: ChartConfig = {
  ...
  name: 'Global Top 50',
  type: 'global',
  description: 'The most listened tracks worldwide right now, updated weekly from Last.fm.',
  method: 'global',
  coverColor: '#6366f1',
  limit: 50,
};
